...
func (m *MockCapCollector) HostExecuteAndStream(mask bool, hostString string, output cli.OutputHandler, _ bool, args ...string) error {
...
func (m *MockCapCollector) HostExecute(mask bool, hostString string, _ bool, args ...string) (response string, err error) {
