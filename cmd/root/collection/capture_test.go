...
func (m *MockCollector) HostExecute(mask bool, hostString string, isCoordinator bool, args ...string) (stdOut string, err error) {
...
func (m *MockCollector) HostExecuteAndStream(mask bool, hostString string, _ cli.OutputHandler, isCoordinator bool, args ...string) error {
	capturedArgs := make(map[string]interface{})
	capturedArgs["hostString"] = hostString
	capturedArgs["isCoordinator"] = isCoordinator
	capturedArgs["args"] = args
