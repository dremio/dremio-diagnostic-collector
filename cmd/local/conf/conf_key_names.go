...
const (
	// KeyVerbose provides output verbosity when the collect command is running,
	...
	// New keys for DDC v4
	KeyCollectTrackerJSON         = "collect-tracker-json"
	KeyCollectHiveDeprecatedLog   = "collect-hive-deprecated-log"
	KeyCollectAsyncProfiler       = "collect-async-profiler"
	KeyStartDate                  = "start-date"
	KeyDiskBandwidthLimitPct      = "disk-bandwidth-limit-pct"
	KeyServerLogsNumDays          = "server-logs-num-days"
	KeyMetaRefreshLogNumDays      = "meta-refresh-log-num-days"
	KeyReflectionLogNumDays       = "reflection-log-num-days"
	KeyTrackerJSONNumDays         = "tracker-json-num-days"
	KeyVacuumLogNumDays           = "vacuum-log-num-days"
	KeyCollectProblematicProfiles = "collect-problematic-profiles"
)
